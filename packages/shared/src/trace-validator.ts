import { 
  ...
  PROTOCOL_VERSIONS 
} from './universal-trace';

export class DefaultTraceValidator implements UniversalTraceValidator {
  validate(trace: UniversalTraceData): ValidationResult {
    ...
    if (trace.protocol_version && !Object.values(PROTOCOL_VERSIONS).includes(trace.protocol_version as any)) {
...
export const traceValidator = new DefaultTraceValidator();
