...
const ErrorNode = ({ data, selected }) => {
    const nodeData = data;
    const getStatusColor = () => {
        return 'border-red-300 bg-red-50';
    };
    return (<div className={`px-4 py-3 shadow-lg rounded-lg border-2 transition-all duration-200 min-w-[200px] max-w-[300px] ${selected ? 'ring-2 ring-red-500 ring-offset-2' : ''} ${getStatusColor()}`}>
