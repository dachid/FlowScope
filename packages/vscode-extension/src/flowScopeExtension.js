...
exports.FlowScopeExtension = void 0;
...
class FlowScopeExtension {
    constructor(context) {
        ...
        this.apiClient = new apiClient_1.FlowScopeApiClient();
    ...
    async initializeConnection() {
        try {
            ...
            vscode.window.showWarningMessage('FlowScope: Could not connect to backend server. Please ensure the FlowScope backend is running.');
        }
    }
    async openDebugger() {
        // Create and show the main debugger webview panel
        const panel = vscode.window.createWebviewPanel('flowscopeDebugger', 'FlowScope Debugger', vscode.ViewColumn.Beside, {
            enableScripts: true,
    ...
    getDebuggerWebviewContent(webview) {
...
exports.FlowScopeExtension = FlowScopeExtension;
