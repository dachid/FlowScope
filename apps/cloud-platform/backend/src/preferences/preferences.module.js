...
exports.PreferencesModule = PreferencesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [preferences_controller_1.UserPreferencesController, preferences_controller_1.BookmarksController],
        providers: [user_preferences_service_1.UserPreferencesService],
        exports: [user_preferences_service_1.UserPreferencesService],
    })
], PreferencesModule);
